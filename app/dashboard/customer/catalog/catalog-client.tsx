...
export function CatalogClient({
  ...
  return (
    <>
      {/* Mengurangi gap antar elemen layout utama */}
        ...
        <div className="flex flex-col lg:flex-row gap-6 items-start">
          ...
          <aside className="w-full lg:w-64 flex-shrink-0 lg:sticky lg:top-24">
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden flex flex-col">
              ...
              {/* PERBAIKAN SCROLL AREA:
                  Menggunakan 'h-full' atau kalkulasi viewport yang lebih aman. 
                  Di desktop, kita set max-height relative ke viewport dikurangi header/navbar.
              */}
              <ScrollArea className="h-[60vh] lg:h-[calc(100vh-180px)] w-full">
                <div className="p-2 pb-10"> {/* Tambahan padding bottom agar item terakhir tidak mepet */}
